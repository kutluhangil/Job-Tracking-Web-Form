            ...
            >
                <div className="apple-card p-10 md:p-12">
                    <div className="text-center mb-10">
                        ...
                        <Text>NextStep hesabınıza erişin.</Text>
                    </div>
                    ...
                    <form onSubmit={handleLogin} className="flex flex-col gap-6">
                        ...
                        <button
                            ...
                            className="mt-4 w-full rounded-full bg-black py-4 text-base font-medium text-white transition-all hover:bg-black/80 disabled:opacity-50"
                        >
